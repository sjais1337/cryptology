...
#ifdef __CUDA_ARCH__
    // GPU Hardware Instruction (1 clock cycle)
    #define ROTRIGHT(a,b) __funnelshift_r((a), (a), (b))
    #define ROTLEFT(a,b)  __funnelshift_l((a), (a), (b))
#else
    // CPU Software Fallback (3 clock cycles)
...
__forceinline__ __device__ void sha256_transform(SHA256_CTX *ctx, const BYTE data[])
{
